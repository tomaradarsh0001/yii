            ...
            <div class="dropdown-menu dropdown-menu-start dropdown-mega" aria-labelledby="megaDropdown">
                <div class="d-md-flex align-items-start justify-content-start">
                    <div class="dropdown-mega-list">
                        ...
                        <a class="dropdown-item" href="<?= Url::to(['settings/index'])?>">Roles & Permissions</a>
                    ...
                    <div class="dropdown-mega-list">
                        <div class="dropdown-header">Masters</div>
                        <a class="dropdown-item" href="<?= Url::to(["material/create"])?>">Material</a>
                        <a class="dropdown-item" href="<?= Url::to(["material-category/create"])?>">Material Category</a>
                        <a class="dropdown-item" href="<?= Url::to(["material-category-mapping/create"])?>">Material Categroy Mapping</a>
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class='dropdown-item' href='pages-settings.html'><i class="align-middle me-1" data-feather="settings"></i> Settings &
                        Privacy</a>
                    <a class="dropdown-item" href="#">supplier Help Center</a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="<?= Url::to(['/site/logout']) ?>" data-method="post">Log out</a>
                </div>
            </li>
        </ul>
    </div>
