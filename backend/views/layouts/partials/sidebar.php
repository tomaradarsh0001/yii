				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item">
						...
						<ul id="customers" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
							<li class="sidebar-item"><a class='sidebar-link' href='<?= Url::to(["customer/create"])?>'>Add Customer</a></li>
							<li class="sidebar-item"><a class='sidebar-link' href='<?= Url::to(["customer/index"])?>'>Manage Customers </a></li>
						</ul>
					</li>
					...
					<li class="sidebar-item">
						...
						<ul id="suppliers" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
							<li class="sidebar-item"><a class='sidebar-link' href='<?= Url::to(["supplier/create"])?>'>Add Supplier</a></li>
							<li class="sidebar-item"><a class='sidebar-link' href='<?= Url::to(["supplier/index"])?>'>Manage Suppliers</a></li>
						</ul>
					</li>
